        ...
        .then(data => {
            ...
            if (data.length === 0) {
                ...
                data.forEach(user => {
                    ...
                    <div class="acciones">
                        <!-- Botón Editar -->
                        <button title="Editar" class="texto-emergente btn-editar" onclick="btnEditarEmpleado(${user.id_empleado});">
                        ...
                        ${user.estado_empleado == 1 ? `
                            <button title="Deshabilitar" class="texto-emergente btn-deshabilitar" onclick="btnDeshabilitarEmpleado(${user.id_empleado});">
                        ...
                        ${user.estado_empleado == 0 ? `
                            <button title="Habilitar" class="texto-emergente btn-habilitar" onclick="btnHabilitarEmpleado(${user.id_empleado});">
