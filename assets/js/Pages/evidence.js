if (currentPath.includes("/Evidence")) {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        toggleBtn.addEventListener('click', () => {
            filtros.classList.toggle('show-filters');
        });
...
function generarZip(data) {
    ...
    if (cantidadArchivos == 0) {
        ...
        Swal.fire({
            ...
            text: "Se descargara un archivo .zip, la descarga puede ser tardada.",
            icon: "warning",
        ...
        success: function (response) {
            try {
                if (response.length > 0) {
                    ...
                    downloadButton.classList.add('button-add', 'download');

                    if (data.tipo_archivo === 'application/pdf') {
                        downloadButton.classList.add('pdf');
                    }
                    ...
                    deleteButton.classList.add('button-add' , 'delete');
                    ...
                    if (data.tipo_archivo === 'application/pdf') {
                        ...
                        openPdfButton.classList.add('pdf' , 'button-add');
