            ...
            if (data.length === 0) {
                ...
                data.forEach(branch => {
                    ...
                    <td>
                        <div class="acciones">
                            <!-- Botón Editar -->
                            <button title="Editar" class="texto-emergente btn-editar" onclick="btnEditarSucursal(${branch.id_sucursal});">
                            ...
                            ${branch.estado_sucursal == 1 ? `
                                <button title="Deshabilitar" class="texto-emergente btn-deshabilitar" onclick="btnDeshabilitarSucursal(${branch.id_sucursal});">
                            ...
                            ${branch.estado_sucursal == 0 ? `
                                <button title="Habilitar" class="texto-emergente btn-habilitar" onclick="btnHabilitarSucursal(${branch.id_sucursal});">
